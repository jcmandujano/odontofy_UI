...
const LOCAL_SVG_ICONS = {
  ...
  mainDashboardAgenda: '/icons/main-dashboard-agenda.svg',
  mainDashboardAppointmentDot: '/icons/main-dashboard-appointment-dot.svg',
  mainDashboardConsents: '/icons/main-dashboard-consents.svg',
  mainDashboardFinance: '/icons/main-dashboard-finance.svg',
  mainDashboardFinanceHidden: '/icons/main-dashboard-finance-hidden.svg',
  mainDashboardFinanceVisible: '/icons/main-dashboard-finance-visible.svg',
  mainDashboardPatients: '/icons/main-dashboard-patients.svg',
